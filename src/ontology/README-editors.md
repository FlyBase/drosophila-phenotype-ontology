...
1. Reference an external ontology class in the edit ontology. In Protege: add as a new class directly under owl:Thing and paste in the PURL, then add a relationship to the new term from a dpo term.
